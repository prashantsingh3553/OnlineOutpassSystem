    ...
    <div class="modal-content">
      <div class="modal-header text-center">
        ...
        <div class="md-form mb-5">
          <label data-error="wrong" id="mssg" data-success="right" for="defaultForm-email" style="position:absolute; text-align:center;">Your Application has been submitted sucessfully..!!!</label>
        </div>
...
<!--    Congrats Modal End-->
  ...
  <header>
    ...
    <ul class="custom-scrollbar">
      ...
      <div class="list-group list-group-flush">
        <a href="studentDashboard.php" class="list-group-item active waves-effect">
  ...
  <main class="pt-5 mx-lg-5">
    <div class="container-fluid mt-5">
        ...
        <form class="text-center border border-light p-5" name="form1" method="post" action="../connection/outpass-submit.php">

            <p class="h4 mb-4">Outpass</p>
            ...
            <div class="form-row mb-4">
                ...
                <div class="col" style="top:20px;">
                    <span style="position: absolute; left: 10px; font-weight: 700; top: 8px;">Select Date : </span>
                    <input type="date" id="date" name="date" class="form-control mb-4" placeholder="Date" style="position: relative; left: 120px; width: 250px;" required>                    
                </div>
                <div class="col" style="top:20px;">
                    <input type="number" id="contactnumber" name="contact" class="form-control" placeholder="Contact No." style="width:285px;" required>
            ...
            <!-- Sign up button -->
            <div id="success-msg" data-toggle="modal" data-target="#modalLoginForm">
            <button class="btn btn-default btn-rounded mb-4 btn-info my-4 btn-block btn-default btn-rounded mb-4" type="submit" name="outpassSubmit">Submit</button>
            </div>
