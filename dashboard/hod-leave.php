...
<head>
  ...
  <title>Dashboard | Welcome</title>
    ...
    <?php include '../connection/login-index.php'; include '../connection/hod-leavepermit.php'; ?>
...
<body class="grey lighten-3" style="overflow-x:hidden;">
  ...
  <header>
    ...
    <ul class="custom-scrollbar">
      ...
      <div class="list-group list-group-flush">
        <a href="hodDashboard.php" class="list-group-item waves-effect">
          <i class="fas fa-running mr-3"></i>Outpass
        </a>
        <a href="#" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-bed mr-3"></i>Night Out</a>
        <a href="hod-leave.php" class="list-group-item list-group-item-action active waves-effect">
  ...
  <main class="pt-5 mx-lg-5">
    <div class="container-fluid mt-5">
            ...
            <p class="h4 mb-4">Pending Leave Applications</p>

         <div style="position:absolute; bottom:40px; overflow-y:auto; height:450px; width:1000px;">   
  ...
  <tbody>
      ...
      $sql = "Select * from outpassDB where hod = 0 and type = 'leave'";
      ...
      if($resultcheck > 0){
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            $sql2 = "Select * from studentLogin where regno =". $row['regno']."";
            ...
            echo "<tr>
                    ...
                    <td>".$row2["rollno"]."</td>
                    <td>".$row2["year"]." ".$row2["branch"]."</td>                    
                    <td>".$row["contact"]."</td>
                    <td>".$row["parentcontact"]."</td>
                    <td>".$row["whereto"]."</td>
                    <td>".$row["reason"]."</td>
                    <td>
                    <form method='get' action='../connection/hod-leavepermit.php'>
                    <input type='text' value='".$row["id"]."' name='id' style='display:none;' >
                    
                    <input type='submit' id='permit' name='hodpermit' class='btn btn-success' value='Permit'>
                    
                    
                    <input type='submit' id='deny' name='hoddeny' class='btn btn-danger' value='Deny' style='width:113px;'>
                    </form>
                    </td>
                    </tr>
