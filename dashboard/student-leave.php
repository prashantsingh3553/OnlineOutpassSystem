...
<!--    Congrats Modal End-->
  ...
  <main class="pt-5 mx-lg-5">
    <div class="container-fluid mt-5">
        ...
        <form class="text-center border border-light p-5" method="post" action="../connection/leave-submit.php">

            <p class="h4 mb-4">Leave Application</p>
            ...
            <div class="form-row mb-4">
                <div class="col" style="top:20px;">
                    ...
                    <input type="text" id="hostel" name="hostel" class="form-control mb-4" placeholder="Flank with Room No. eg: C102" style="position: relative; left: 170px; width: 400px;" required>
                </div>
            </div>
            ...
            <div class="form-row mb-4">
                ...
                <div class="col">
                    <span style="position: absolute; left: 10px; font-weight: 700; top: 8px;">From : </span>
                    <input type="date" id="date" name="from" class="form-control mb-4" placeholder="Date" style="position: relative; left: 170px; width: 250px;" required>
                </div>
                <div class="col">
                    <span style="position: absolute; left: 10px; font-weight: 700; top: 8px;">To : </span>
                    <input type="date" id="date" name="to" class="form-control mb-4" placeholder="Date" style="position: relative; left: 170px; width: 250px;" required>                    
                </div>
            </div>
            ...
            <div class="form-row mb-4">    
                <div class="col" style="top:-16px;">
                    ...
                    <input type="number" id="contactnumber" name="studentcontact" class="form-control" placeholder="Contact No." style="position: relative; left: 170px; width: 250px;" required>
                    <label id="cntct-mssg1" style="position:relative; left:-100px; font-size:12px; color:red;"></label>
                </div>
                <div class="col" style="top:-16px;">
                    <span style="position: absolute; left: 10px; font-weight: 700; top: 8px;">Parent's Contact : </span>
                    <input type="number" id="parentnumber" name="parentcontact" class="form-control" placeholder="Contact No." style="position: relative; left: 170px; width: 250px;" required>
            ...
            <div class="form-row mb-4">
                ...
                <div class="col">
                    ...
                    <textarea id="whereto" name="whereto" class="form-control mb-4" placeholder="Enter your Destination..!!!" style="position: relative; left: 120px; width: 600px;" required></textarea>
                </div>
            </div>
            <div class="form-row mb-4">
                ...
                <div class="col">
                    ...
                    <textarea id="whereto" name="reason" class="form-control mb-4" placeholder="Reason..!!!" style="position: relative; left: 120px; width: 600px;" required></textarea>
                </div>
            </div>
            ...
            <button class="btn btn-default btn-rounded mb-4 btn-info my-4 btn-block btn-default btn-rounded mb-4" type="submit" name="leaveSubmit">Submit</button>
            </div>
