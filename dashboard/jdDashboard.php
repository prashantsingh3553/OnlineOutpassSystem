...
<head>
  ...
  <title>Dashboard | Welcome</title>
    ...
    <?php include '../connection/login-index.php'; include '../connection/hod-outpasspermit.php'; ?>
...
<body class="grey lighten-3" style="overflow-x:hidden;">
  ...
  <tbody>
      ...
      $sql = "Select * from outpassDB where jd = 0 && type = 'leave'";
      ...
      if($resultcheck > 0){
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            echo "<tr>
                    ...
                    <td>".$row["reason"]."</td>
                    <td>
                    <form method='get' action='../connection/jd-leavepermit.php'>
                    <input type='text' value='".$row["id"]."' name='id' style='display:none;' >
                    
                    <input type='submit' id='permit' name='jdpermit' class='btn btn-success' value='Permit'>
                    
                    
                    <input type='submit' id='deny' name='jddeny' class='btn btn-danger' value='Deny' style='width:113px;'>
                    </form>
                    </td>
                    </tr>
