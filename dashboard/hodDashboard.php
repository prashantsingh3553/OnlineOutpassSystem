...
<body class="grey lighten-3" style="overflow-x:hidden;">
  ...
  <header>
    ...
    <ul class="custom-scrollbar">
      ...
      <div class="list-group list-group-flush">
        <a href="hodDashboard.php" class="list-group-item active waves-effect">
          <i class="fas fa-running mr-3"></i>Outpass
        </a>
        <a href="#" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-bed mr-3"></i>Night Out</a>
        <a href="hod-leave.php" class="list-group-item list-group-item-action waves-effect">
  ...
  <main class="pt-5 mx-lg-5">
    <div class="container-fluid mt-5">
            ...
            <p class="h4 mb-4">Pending Outpass Applications</p>
  ...
  <tbody>
      ...
      $sql = "Select * from outpassDB where hod = 0 and type = 'outpass'";
      ...
      if($resultcheck > 0){
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            echo "<tr>
                    ...
                    <td>".$row["reason"]."</td>
                    <td>
                    <form method='get' action='../connection/hod-outpasspermit.php'>
